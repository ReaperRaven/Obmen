...
Label(text='Выберите код валюты').pack(padx=10, pady=10) #выбор валюты из списка

combobox = ttk.Combobox(values=list(cur.keys()))
combobox.pack(padx=10, pady=10)
combobox.bind('<<ComboboxSelected>>', update_c_label)

# entry = Entry() #ввод валюты
#entry.pack(padx=10, pady=10)

c_label = ttk.Label(text='')
c_label.pack(padx=10, pady=10)

Button(text='Получит курс обмена к доллару', command=exchange).pack(padx=10, pady=10)
